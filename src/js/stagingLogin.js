class Login extends HTMLElement {
    constructor() {
        super();
        this.attachShadow({ mode: "open" }); //apparently slots only work with the shadow dom?
    }
    connectedCallback() {
        this.html = `<style>
        /****** LOGIN MODAL ******/
      ...
      <div class="modal fade" id="login-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="loginmodal-container">
            <h1>Login</h1><br>
            <p>Please login to view <code>staging.holmscykler.dk</code></p>
            <form>
...
customElements.define("holmscykler-login", Login);
if (!localStorage.getItem("holmscykler-totally-logged-in")) {
    ...
    div.innerHTML = "<holmscykler-login />";
